...
module lab8_soc_mm_interconnect_0 (
	...
	wire          cmd_mux_013_src_valid;                                                              // cmd_mux_013:src_valid -> keycode1_s1_agent:cp_valid
	wire  [106:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> keycode1_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                              // keycode1_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [14:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> keycode1_s1_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                                      // cmd_mux_013:src_startofpacket -> keycode1_s1_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                                        // cmd_mux_013:src_endofpacket -> keycode1_s1_agent:cp_endofpacket
	...
	wire          keycode1_s1_agent_rp_valid;                                                         // keycode1_s1_agent:rp_valid -> router_015:sink_valid
	wire  [106:0] keycode1_s1_agent_rp_data;                                                          // keycode1_s1_agent:rp_data -> router_015:sink_data
	wire          keycode1_s1_agent_rp_ready;                                                         // router_015:sink_ready -> keycode1_s1_agent:rp_ready
	wire          keycode1_s1_agent_rp_startofpacket;                                                 // keycode1_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          keycode1_s1_agent_rp_endofpacket;                                                   // keycode1_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire          keycode1_s1_agent_rdata_fifo_src_valid;                                             // keycode1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] keycode1_s1_agent_rdata_fifo_src_data;                                              // keycode1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          keycode1_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_013:in_0_ready -> keycode1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                                  // avalon_st_adapter_013:out_0_valid -> keycode1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                                   // avalon_st_adapter_013:out_0_data -> keycode1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                                  // keycode1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                                  // avalon_st_adapter_013:out_0_error -> keycode1_s1_agent:rdata_fifo_sink_error
